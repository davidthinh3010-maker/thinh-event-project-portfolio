...
const timeline: TimelineGroup[] = [
  ...
  },
  {
    year: '2022', company: 'Kingsmen Vietnam', projects: [
      ...
      {
        id:'tokyo', name:'Tokyo Festival — Saigon Centre', type:lt('Exhibition / Mall Activation','Triển lãm / Kích hoạt tại TTTM'), role:lt('Event Coordinator','Điều phối sự kiện'),
        detail:lt('Drawing · Timeline · Technical checks · Mall coordination · Handover','Bản vẽ · Timeline · Kiểm tra kỹ thuật · Phối hợp TTTM · Bàn giao'),
        story:lt('Tokyo Festival introduced me to the discipline of mall coordination. The project moved from drawings to technical checks, contractor execution, mall inspection and final handover. I followed the chain closely so each requirement was handled before it became a blocker for the next step.','Tokyo Festival giúp tôi hiểu rõ hơn kỷ luật khi làm việc trong môi trường trung tâm thương mại. Dự án đi từ bản vẽ, kiểm tra kỹ thuật, thi công của nhà thầu, nghiệm thu với mall đến bàn giao cuối cùng. Tôi bám sát từng mắt xích để các yêu cầu được xử lý trước khi trở thành điểm nghẽn cho bước tiếp theo.'),
        handled:ll(['Received and followed technical drawings.','Tracked the timeline and checked technical details onsite.','Coordinated contractors and the Saigon Centre / mall team.','Supported inspection, acceptance and handover.'],['Tiếp nhận và bám theo bản vẽ kỹ thuật.','Theo dõi timeline và kiểm tra các chi tiết kỹ thuật onsite.','Điều phối nhà thầu và đội ngũ Saigon Centre / trung tâm thương mại.','Hỗ trợ kiểm tra, nghiệm thu và bàn giao.']),
        ...
        outcome:lt('Developed stronger venue coordination habits and a more structured approach to technical handover.','Phát triển khả năng phối hợp địa điểm và cách làm việc có cấu trúc hơn với các yêu cầu kỹ thuật, nghiệm thu và bàn giao.'), image:'/assets/tokyo.jpg',
      },
      {
  ...
  },
  {
    year:'2026', company:'Kingsmen Vietnam · KKO.vn · Independent · Tâm Anh Research Institute', projects:[
      ...
      },
      {
        ...
        detail:lt('Documentation · Vendor sourcing · Mall meetings · Site supervision · Handover','Hồ sơ · Tìm vendor · Họp mall · Giám sát onsite · Bàn giao mặt bằng'),
        story:lt('Gintell is important in my portfolio because I handled the process independently from start to finish. I prepared the required documentation, sourced vendors, joined mall meetings, supervised dismantling onsite and coordinated final handover. It is a small project compared with a large event, but it shows ownership clearly.','Gintell là dự án quan trọng trong portfolio vì tôi tự phụ trách quy trình từ đầu đến cuối. Tôi chuẩn bị hồ sơ, tìm vendor, tham gia họp với mall, giám sát tháo dỡ onsite và phối hợp bàn giao mặt bằng. Quy mô nhỏ hơn một đại sự kiện, nhưng thể hiện rất rõ mức độ ownership của tôi.'),
        handled:ll(['Prepared required project documentation.','Sourced and coordinated vendors.','Joined meetings with the mall to align procedures and site requirements.','Supervised dismantling work and final site handover.'],['Chuẩn bị hồ sơ cần thiết cho dự án.','Tìm kiếm và điều phối vendor.','Tham gia họp với mall để thống nhất quy trình và yêu cầu hiện trường.','Giám sát tháo dỡ và bàn giao mặt bằng cuối cùng.']),
        flow:lt('Documentation → Vendor Sourcing → Mall Meeting → Site Supervision → Handover','Hồ sơ → Tìm vendor → Họp mall → Giám sát hiện trường → Bàn giao'), outcome:lt('Demonstrated end-to-end ownership across paperwork, sourcing, stakeholder coordination, site supervision and handover.','Thể hiện khả năng sở hữu dự án end-to-end từ hồ sơ, tìm vendor, phối hợp các bên đến giám sát onsite và bàn giao.'),
      },
      {
